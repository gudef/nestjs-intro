...
describe('CreateUserDto', () => {
    ...
    it('should fail without 1 uppercase letter', async () => {
        await testPassword('abcdefa', 'Password must contain at least 1 uppercase letter');
    })

    it('should fail without at least 1 number', async () => {
        await testPassword('abcdefaA', 'Password must contain at least 1 number')

    })

    it('should fail without at least 1 special character', async () => {
        await testPassword('abcdefaA1', 'Password must contain at least 1 special character')
